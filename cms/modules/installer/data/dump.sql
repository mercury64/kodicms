...
INSERT INTO `TABLE_PREFIX_page_behavior_settings` (`page_id`, `behavior_id`, `data`) VALUES
...
INSERT INTO `TABLE_PREFIX_datasources` (`ds_id`, `ds_type`, `docs`, `indexed`, `name`, `description`, `created_on`, `updated_on`, `internal`, `locks`, `code`) VALUES
...
INSERT INTO `TABLE_PREFIX_dshfields` (`id`, `ds_id`, `name`, `family`, `type`, `header`, `from_ds`, `props`) VALUES
...
INSERT INTO `TABLE_PREFIX_hybriddatasources` (`ds_id`, `parent`, `ds_key`, `path`) VALUES
(2, 0, 'news', '0,2');

INSERT INTO `TABLE_PREFIX_dshybrid` (`id`, `ds_id`, `published`, `header`, `created_on`, `updated_on`) VALUES
...
INSERT INTO `TABLE_PREFIX_dshybrid_2` (`id`, `f_created_on`, `f_slug`, `f_anounce`, `f_text`, `f_relatednews`, `f_image`) VALUES
