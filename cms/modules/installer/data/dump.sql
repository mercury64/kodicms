...
INSERT INTO `dshybrid` (`id`, `ds_id`, `published`, `header`, `created_on`, `updated_on`) VALUES
...
INSERT INTO `dshybrid_2` (`id`, `f_created_on`, `f_slug`, `f_anounce`, `f_text`, `f_relatednews`, `f_image`) VALUES
