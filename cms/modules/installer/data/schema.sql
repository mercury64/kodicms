...
CREATE TABLE IF NOT EXISTS `TABLE_PREFIX_datasources` (
...
CREATE TABLE IF NOT EXISTS `TABLE_PREFIX_dshfields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `TABLE_PREFIX_hybriddatasources` (
  `ds_id` int(11) unsigned NOT NULL DEFAULT '0',
