...
window.elFinder = function(node, opts) {
	 ...
	 * @type String
	 **/
	this.cssClass = 'ui-widget ui-panel-body  elfinder panel no-margin lefinder-'+(this.direction == 'rtl' ? 'rtl' : 'ltr')+' '+this.options.cssClass;
 ...
 * @type String
 **/
elFinder.prototype.version = '2.x (Nightly: 5b3b866)';
...
//		$('<span class="input-group-btn"><button class="btn"><i class="fa fa-times" /></button></span>')
//			.appendTo(form)
//			.click(abort)
