...
$dirs = array (
        ...
        $path.'modules/assets',
        $path.'modules/auth',
        $path.'modules/behavior',
        $path.'modules/bootstrap',
        $path.'modules/breadcrumbs',
        $path.'modules/cache',
        $path.'modules/codebench',
        $path.'modules/database',
        $path.'modules/datasource',
        $path.'modules/elfinder',
        $path.'modules/email',
        $path.'modules/email_queue',
        $path.'modules/filesystem',
        $path.'modules/image',
        $path.'modules/installer',
        $path.'modules/kodicms',
        $path.'modules/logs',
        $path.'modules/minion',
        $path.'modules/mptt',
        ...
        $path.'plugins/disqus',
        $path.'plugins/freeride',
        $path.'plugins/gallery',
        $path.'plugins/googleanalytics',
        $path.'plugins/hybrid',
        $path.'plugins/less',
        $path.'plugins/maintenance',
        $path.'plugins/messages',
        $path.'plugins/page_fields',
        $path.'plugins/page_not_found',
        $path.'plugins/part_revision',
        $path.'plugins/redactor',
        $path.'plugins/redirect',
        $path.'plugins/reformal',
        $path.'plugins/test',
        $path.'plugins/typograf',
        $path.'plugins/wetboew',
        $path.'plugins/yandexmetrika'
